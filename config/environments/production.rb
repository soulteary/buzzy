...
Rails.application.configure do
  ...
  if smtp_address = ENV["SMTP_ADDRESS"].presence
    ...
    # In containerized/local production-like runs SMTP is often not configured.
    # Avoid ActionMailer defaulting to localhost:25 and spamming job errors.
  ...
  # Set BASE_URL to your instance's public URL (e.g., https://buzzy.example.com)
  ...
  # config.active_job.queue_name_prefix = "buzzy_production"
