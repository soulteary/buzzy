class User < ApplicationRecord
  ...
  belongs_to :account
  # User is an account-local membership record for a real person (except role=system).
  ...
  private
    ...
    def single_real_user_per_account
      ...
      # Current product mode: one real member per account (workspace) plus the system user.
