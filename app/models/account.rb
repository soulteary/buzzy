class Account < ApplicationRecord
  ...
  # Product wording can call this a "workspace", but it remains the tenant boundary in code and DB.
  ...
  class << self
    def create_with_owner(account:, owner:)
      create!(**account).tap do |account|
        # Keep a dedicated system actor for automated events/comments; not a real member.
