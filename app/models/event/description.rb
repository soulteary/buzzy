class Event::Description
  ...
  private
    ...
    def card
      @card ||= if event.eventable.respond_to?(:card)
    ...
    def action_sentence(creator, card_title)
      ...
      when "card_mentioned", "comment_mentioned"
        mentioned_sentence(creator, card_title)
      when "card_unmentioned", "comment_unmentioned"
        unmentioned_sentence(creator, card_title)
      when "card_published"
    ...
    def mentioned_sentence(creator, card_title)
      mentionees = h(event.mentionees.pluck(:name).to_sentence)
      I18n.t("events.descriptions.mentioned", creator: creator, card_title: card_title, mentionees: mentionees)
    end

    def unmentioned_sentence(creator, card_title)
      mentionees = h(event.mentionees.pluck(:name).to_sentence)
      I18n.t("events.descriptions.unmentioned", creator: creator, card_title: card_title, mentionees: mentionees)
    end
end
