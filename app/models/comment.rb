class Comment < ApplicationRecord
  include Attachments, Eventable, Mentions, OperationLoggable, Promptable, Searchable, Storage::Tracked
  ...
  scope :preloaded, -> { with_rich_text_body.includes(:creator, :event, reactions: :reacter) }
