...
class MentionsTest < ActiveSupport::TestCase
  ...
  test "normalizes action-text-attachment gid to sgid on save (Lexxy-style submission)" do
    user = users(:kevin)
    ...
    assert_not body.include?(" gid="), "Stored body should not contain gid attribute after normalizer"
  end
