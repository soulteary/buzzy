...
class Columns::LeftPositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "move column left" do
    ...
    post user_board_column_left_position_path(board.url_user, board, column_b), as: :turbo_stream
  ...
  test "move left refreshes adjacent columns" do
    ...
    post user_board_column_left_position_path(board.url_user, board, column), as: :turbo_stream
