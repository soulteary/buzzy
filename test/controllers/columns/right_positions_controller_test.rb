...
class Columns::RightPositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "move column right" do
    ...
    post user_board_column_right_position_path(board.url_user, board, column_a), as: :turbo_stream
  ...
  test "move right refreshes adjacent columns" do
    ...
    post user_board_column_right_position_path(board.url_user, board, column), as: :turbo_stream
