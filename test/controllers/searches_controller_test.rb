...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "search" do
    ...
    get search_path(q: "broken", script_name: @account.slug)
    ...
    get search_path(q: "overflowing", script_name: @account.slug)
    ...
    get search_path(q: "haggis", script_name: @account.slug)
    ...
    get search_path(q: @card.id, script_name: @account.slug)
    assert_select "form[data-controller='auto-submit']"

    # Searching with non-existent card id
    get search_path(q: "999999", script_name: @account.slug)
  ...
  test "search highlights matched terms with proper HTML marks" do
    ...
    get search_path(q: "highlighting", script_name: @account.slug)
  ...
  test "search preserves highlight marks but escapes surrounding HTML" do
    ...
    get search_path(q: "testing", script_name: @account.slug)
    assert_response :success
