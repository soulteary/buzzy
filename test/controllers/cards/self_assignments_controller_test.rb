...
class Cards::SelfAssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "create assigns to current user" do
    ...
    post user_board_card_self_assignment_path(card.board.url_user, card.board, card), as: :turbo_stream
  ...
  test "create as JSON" do
    ...
    post user_board_card_self_assignment_path(card.board.url_user, card.board, card), as: :json
