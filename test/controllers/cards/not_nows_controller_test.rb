...
class Cards::NotNowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "create" do
    ...
    assert_changes -> { card.reload.postponed? }, from: false, to: true do
      post user_board_card_not_now_path(card.board.url_user, card.board, card), as: :turbo_stream
  ...
  test "create as JSON" do
    ...
    post user_board_card_not_now_path(card.board.url_user, card.board, card), as: :json
