...
class Account::ExportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "create and show return not_found when export data is disabled" do
    Buzzy.instance_variable_set(:@export_data_enabled, false)
    ...
    Buzzy.remove_instance_variable(:@export_data_enabled) if Buzzy.instance_variable_defined?(:@export_data_enabled)
  end
