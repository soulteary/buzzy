...
ActiveRecord::Schema[8.1].define(version: 2026_02_12_000000) do
  ...
  create_table "operation_logs", id: :uuid, force: :cascade do |t|
    t.uuid "account_id", null: false
    t.string "action", limit: 255, null: false
    t.uuid "board_id"
    ...
    t.index ["action", "created_at"], name: "index_operation_logs_on_action_and_created_at"
  ...
  create_table "sensitive_audit_logs", id: :uuid, force: :cascade do |t|
    t.uuid "account_id", null: false
    t.string "action", limit: 255, null: false
    t.datetime "created_at", null: false
    t.string "ip_address", limit: 255
  ...
  create_table "user_follows", id: :uuid, force: :cascade do |t|
    t.datetime "created_at", null: false
