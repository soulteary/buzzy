...
ActiveRecord::Schema[8.1].define(version: 2026_02_11_100004) do
  ...
  create_table "accounts", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["deleted_by_id"], name: "index_accounts_on_deleted_by_id"
  ...
  create_table "boards", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "deleted_at"
    t.uuid "deleted_by_id"
    t.boolean "edit_locked", default: false, null: false
    t.datetime "edit_locked_at"
    t.uuid "edit_locked_by_id"
    t.string "name", null: false
    t.datetime "updated_at", null: false
    t.boolean "visibility_locked", default: false, null: false
    t.datetime "visibility_locked_at"
    t.uuid "visibility_locked_by_id"
    ...
    t.index ["deleted_by_id"], name: "index_boards_on_deleted_by_id"
    t.index ["edit_locked_by_id"], name: "index_boards_on_edit_locked_by_id"
    t.index ["visibility_locked_by_id"], name: "index_boards_on_visibility_locked_by_id"
  end
  ...
  create_table "cards", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["deleted_by_id"], name: "index_cards_on_deleted_by_id"
  end
  ...
  create_table "identities", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.boolean "session_transfer_enabled", default: true, null: false
    t.datetime "updated_at", null: false
  ...
  create_table "identity_access_token_show_tokens", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.uuid "access_token_id", null: false
    t.datetime "created_at", null: false
    t.datetime "expires_at", null: false
    t.datetime "updated_at", null: false
    t.index ["access_token_id"], name: "index_identity_access_token_show_tokens_on_access_token_id"
    t.index ["expires_at"], name: "index_identity_access_token_show_tokens_on_expires_at"
  end

  create_table "identity_transfer_tokens", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "expires_at", null: false
    t.uuid "identity_id", null: false
    t.datetime "updated_at", null: false
    t.index ["expires_at"], name: "index_identity_transfer_tokens_on_expires_at"
    t.index ["identity_id"], name: "index_identity_transfer_tokens_on_identity_id"
  end
  ...
  create_table "operation_logs", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.uuid "account_id", null: false
    t.string "action", null: false
    t.uuid "board_id"
    t.json "changes_payload"
    t.string "ip_address"
    t.string "request_id"
    t.uuid "subject_id"
    ...
    t.uuid "user_id"
    t.datetime "created_at", null: false
    t.index ["account_id", "created_at"], name: "index_operation_logs_on_account_id_and_created_at"
    t.index ["account_id"], name: "index_operation_logs_on_account_id"
    t.index ["board_id", "created_at"], name: "index_operation_logs_on_board_id_and_created_at"
    t.index ["board_id"], name: "index_operation_logs_on_board_id"
    t.index ["subject_type", "subject_id"], name: "index_operation_logs_on_subject_type_and_subject_id"
  ...
  create_table "sensitive_audit_logs", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.uuid "account_id", null: false
    t.string "action", null: false
    t.string "ip_address"
    t.json "metadata"
    ...
    t.uuid "user_id"
    t.datetime "created_at", null: false
    t.index ["account_id", "created_at"], name: "index_sensitive_audit_logs_on_account_id_and_created_at"
    t.index ["account_id"], name: "index_sensitive_audit_logs_on_account_id"
    t.index ["action", "created_at"], name: "index_sensitive_audit_logs_on_action_and_created_at"
    t.index ["subject_type", "subject_id"], name: "index_sensitive_audit_logs_on_subject_type_and_subject_id"
    t.index ["user_id"], name: "index_sensitive_audit_logs_on_user_id"
  end
  ...
  create_table "user_follows", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "users", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["frozen_by_id"], name: "index_users_on_frozen_by_id"
