...
Buzzy has an API that allows you to integrate your application with it or to create
a bot to perform various actions for you.

## Authentication

There are two ways to authenticate with the Buzzy API:
...
```bash
curl -H "Authorization: Bearer put-your-access-token-here" -H "Accept: application/json" https://app.buzzy.do/my/identity
```
...
curl -X POST \
  ...
  -d '{"code": "ABC123"}' \
  https://app.buzzy.do/session/magic_link
```
...
curl -H "Cookie: session_token=eyJfcmFpbHMi..." \
  -H "Accept: application/json" \
  https://app.buzzy.do/my/identity
```
...
```bash
curl -H "Authorization: Bearer put-your-access-token-here" -H "Accept: application/json" -v http://buzzy.localhost:3006/686465299/cards
# ...
< link: <http://buzzy.localhost:3006/686465299/cards?page=2>; rel="next"
# ...
```
...
curl -X PUT \
  ...
  http://buzzy.localhost:3006/686465299/users/03f5v9zjw7pz8717a4no1h8a7
```
...
curl -X POST \
  ...
  https://app.buzzy.do/123456/rails/active_storage/direct_uploads
```
...
An Identity represents a person using Buzzy.
  ...
  "accounts": [
    {
      ...
      "user": {
        ...
        "url": "http://buzzy.localhost:3006/users/03f5v9zjw7pz8717a4no1h8a7"
      }
    },
    {
      ...
      "user": {
        ...
        "url": "http://buzzy.localhost:3006/users/03f5v9zppzlksuj4mxba2nbzn"
      }
    }
  ]
}
...
[
  {
    ...
    "url": "http://buzzy.localhost:3006/897362094/boards/03f5v9zkft4hj9qq0lsn9ohcm",
    "creator": {
      "id": "03f5v9zjw7pz8717a4no1h8a7",
      "name": "David Heinemeier Hansson",
      "role": "owner",
      ...
      "email_address": "david@example.com",
      "created_at": "2025-12-05T19:36:35.401Z",
      "url": "http://buzzy.localhost:3006/897362094/users/03f5v9zjw7pz8717a4no1h8a7"
    }
  }
]
```
...
**URL scheme:** Single-card endpoints (show, update, delete, and nested resources such as comments, reactions, steps) use the nested path `/:account_slug/boards/:board_id/cards/:card_number`. The list/filter endpoint remains `GET /:account_slug/cards`. The legacy path `/:account_slug/cards/:card_number` returns 301 redirects to the nested URL.
...
[
  {
    ...
    "url": "http://buzzy.localhost:3006/897362094/cards/4",
    "board": {
      "id": "03f5v9zkft4hj9qq0lsn9ohcm",
      "name": "Buzzy",
      "all_access": true,
    ...
    "comments_url": "http://buzzy.localhost:3006/897362094/cards/4/comments",
    "reactions_url": "http://buzzy.localhost:3006/897362094/cards/4/reactions"
  },
]
```

### `GET /:account_slug/boards/:board_id/cards/:card_number`

Returns a specific card by its number (within the given board).
...
[
  {
    ...
    "board": {
      ...
      "creator": {
        ...
        "created_at": "2025-12-05T19:36:35.401Z",
        "url": "http://buzzy.localhost:3006/897362094/users/03f5v9zjw7pz8717a4no1h8a7",
        "avatar_url": "http://buzzy.localhost:3006/897362094/users/03f5v9zjw7pz8717a4no1h8a7/avatar"
      }
    },
    "creator": {
      "id": "03f5v9zjw7pz8717a4no1h8a7",
...
[
  {
    ...
    "card": {
      "id": "03f5v9zo9qlcwwpyc0ascnikz",
      "url": "http://buzzy.localhost:3006/897362094/cards/03f5v9zo9qlcwwpyc0ascnikz"
    },
    "reactions_url": "http://buzzy.localhost:3006/897362094/cards/3/comments/03f5v9zo9qlcwwpyc0ascnikz/reactions",
    "url": "http://buzzy.localhost:3006/897362094/cards/3/comments/03f5v9zo9qlcwwpyc0ascnikz"
  }
]
```
...
[
  {
    ...
    "url": "http://buzzy.localhost:3006/897362094/cards/3/reactions/03f5v9zo9qlcwwpyc0ascnikz"
  }
]
```
...
[
  {
    ...
    "url": "http://buzzy.localhost:3006/897362094/cards/3/comments/03f5v9zo9qlcwwpyc0ascnikz/reactions/03f5v9zo9qlcwwpyc0ascnikz"
  }
]
```
...
[
  {
    ...
    "title": "bug",
    "created_at": "2025-12-05T19:36:35.534Z",
    "url": "http://buzzy.localhost:3006/897362094/cards?tag_ids[]=03f5v9zo9qlcwwpyc0ascnikz"
  },
  {
    "id": "03f5v9zo9qlcwwpyc0ascnilz",
    "title": "feature",
    "created_at": "2025-12-05T19:36:35.534Z",
    "url": "http://buzzy.localhost:3006/897362094/cards?tag_ids[]=03f5v9zo9qlcwwpyc0ascnilz"
  }
]
```
...
[
  ...
  },
  {
    ...
    "url": "http://buzzy.localhost:3006/897362094/users/03f5v9zjysoy0fqs9yg0ei3hq"
  },
  {
    ...
    "url": "http://buzzy.localhost:3006/897362094/users/03f5v9zk1dtqduod5bkhv3k8m"
  },
  {
    ...
    "url": "http://buzzy.localhost:3006/897362094/users/03f5v9zk3nw9ja92e7s4h2wbe"
  }
]
```
...
[
  {
    ...
    "card": {
      ...
      "title": "Plain text mentions",
      "status": "published",
      "url": "http://buzzy.localhost:3006/897362094/cards/3"
    },
    "url": "http://buzzy.localhost:3006/897362094/notifications/03f5va03bpuvkcjemcxl73ho2"
  }
]
```
