# How to contribute to Buzzy

Buzzy uses GitHub
[discussions](https://github.com/basecamp/buzzy/discussions) to track
feature requests and questions, rather than [the issue
tracker](https://github.com/basecamp/buzzy/issues). If you're considering
