...
OptionParser.new do |opts|
  ...
  opts.on("--host HOST", "Host to prepend (e.g., https://app.buzzy.do)") do |host|
    options[:host] = host
  end
...
if options[:host].nil? || options[:since].nil?
  ...
  puts "Example: bin/rails runner #{__FILE__} --host https://app.buzzy.do --since 2026-01-14T10:00:00Z"
  exit 1
end
